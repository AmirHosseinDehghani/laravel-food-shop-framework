...
class HomeController extends Controller
{
    public function home()
    {
        ...
        $bestShops = $bestSalle = Product::orderByDesc('salle')->take(6)->get();
        $categories = Category::all();
        $products = Product::all();
        $shops = Shop::all();
        return view('home.index', ['baskets' => $baskets, 'shops' => $shops, 'categories' => $categories, 'products' => $products, 'bestSalles' => $bestSalle, 'bestOffs' => $bestOff]);
    }
    ...
    public function product(int $id)
    {
        ...
        return view('home.product', ['relatedProducts' => $relatedProducts, 'products' => $products, 'baskets' => $baskets, 'product' => $product, 'shop' => $shop, 'seller' => $seller, 'price' => $price]);
    }
}
