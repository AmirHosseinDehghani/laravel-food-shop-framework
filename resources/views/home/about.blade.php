...
@endif
<section class="about-us-section py-5 text-center bg-light">
    <div class="container">
        <h2 class="mb-4 fw-bold">درباره فروشگاه ما</h2>
        <p class="lead text-muted mb-5">فروشگاه ما با هدف ارائه‌ی بهترین محصولات غذایی، تجربه‌ای لذت‌بخش از خرید را برای مشتریان فراهم می‌کند.</p>

        <div class="row justify-content-center">
            <div class="col-md-4 mb-3">

                <h5 class="mt-3">سال‌ها تجربه</h5>
                <p class="text-muted">با سابقه‌ای درخشان در تأمین مواد غذایی با کیفیت.</p>
                <h5 class="mt-3">کیفیت بالا</h5>
                <p class="text-muted">بالاترین کیفیت مواد غذایی .</p>
                <h5 class="mt-3">ساختمان شرکت</h5>
                <p class="text-muted">فارس/فسا/خیابان اول.</p>
            </div>
            <div class="col-md-4 mb-3">
                <h5 class="mt-3">ارسال سریع</h5>
                <p class="text-muted">تحویل سریع و مطمئن به سراسر کشور.</p>
                <h5 class="mt-3">فروشندگان گلچین شده</h5>
                <p class="text-muted">تمامی فروشنگدان ما گلچین شده و تایید شده اند.</p>
                <h5 class="mt-3">پرداخت امن</h5>
                <p class="text-muted">تمامی پرداخت ها امن و در درگاه معتبر زرین پال انجام میشود.</p>
