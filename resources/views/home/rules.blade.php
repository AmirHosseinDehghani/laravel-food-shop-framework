...
<section class="container py-5">
    <h2 class="mb-4">قوانین فروشگاه</h2>
    <div class="accordion" id="rulesAccordion">
        <div class="accordion-item">
            <h2 class="accordion-header" id="ruleOne">
            ...
            <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#rulesAccordion">
                <div class="accordion-body">
                    تمامی مشتریان موظف به رعایت قوانین سایت هستند.
                </div>
            </div>
        </div>

        <div class="accordion-item">
            <h2 class="accordion-header" id="ruleTwo">
            ...
            <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#rulesAccordion">
                <div class="accordion-body">
                    سفارش‌ها تا ۲۴ ساعت قابل لغو هستند.
                </div>
            </div>
        </div>
        <!-- ادامه قوانین... -->
