    ...
    <nav class="vertnav navbar navbar-light">
        ...
        <ul class="navbar-nav flex-fill w-100 mb-2">
            <li class="nav-item dropdown">
                <a href="{{ route('manage.admin.admin') }}"  class=" nav-link">
                    <i class="fe fe-settings fe-16"></i>
                    <span class="ml-3 item-text">مدیریت ادمین ها</span>
                </a>
            </li>
            <li class="nav-item dropdown">
            ...
            <li class="nav-item dropdown">
                <a href="{{ route('conversion.check') }}"  class=" nav-link">
                    <i class="fe fe-settings fe-16"></i>
                    <span class="ml-3 item-text">مدیریت مکالمه ها</span>
                </a>
            </li>
            <li class="nav-item dropdown">
                <a href="{{ route('manage-comment') }}"  class=" nav-link">
                    <i class="fe fe-settings fe-16"></i>
                    <span class="ml-3 item-text">مدیریت نظرات</span>
                </a>
            </li>
            <li class="nav-item dropdown">
