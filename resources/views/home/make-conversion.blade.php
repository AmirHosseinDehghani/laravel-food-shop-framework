...
<section class="py-5 bg-light">
    <div class="container d-flex justify-content-center">
        <div class="col-lg-10 bg-white rounded-4 shadow p-5 position-relative overflow-hidden animate__animated animate__fadeIn"
             style="background: linear-gradient(135deg, #f8f9fa 0%, #e0f7fa 100%), url('{{ asset('img/images/bg-leaves-img-pattern.png') }}') no-repeat right bottom / contain;">
            ...
            <form action="{{route('ticket.start')}}" method="POST" class="needs-validation" novalidate>
                ...
                <div class="row mb-4">
                    <div class="col-md-6 mb-3 mb-md-0">
                        ...
                        <input type="text" id="subject" name="subject" class="form-control form-control-lg border-primary shadow-sm" required placeholder="مثلاً مشکل در پرداخت">
                    ...
                    <div class="col-md-6">
                        ...
                        <select id="type" name="company" class="form-select form-select-lg border-primary shadow-sm" required>
                            ...
                            <option value="comment">نظرات و کامت ها</option>
                        </select>
...
{{-- انیمیشن Animate.css (در صورت نیاز) --}}
