        ...
        <ul class="navbar-nav flex-fill w-100 mb-2">
            <li class="nav-item dropdown">
                <a href="#ui-elements" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle nav-link">
                    ...
                    <span class="ml-3 item-text"> مدیریت فروشگاه </span>
                </a>
                <ul class="collapse list-unstyled pl-4 w-100" id="ui-elements">
                    <li class="nav-item">

                        <a class="nav-link pl-3" href="{{ route('shop.form') }}">
                            <i class="fe fe-plus  fe-16"></i>
                            <span class="ml-1 item-text"> افزودن فروشگاه </span>
                        </a>
                    </li>
                </ul>
                <ul class="collapse list-unstyled pl-4 w-100" id="ui-elements">
                    <li class="nav-item">
                        <a class="nav-link pl-3" href="{{ route('shop.manage') }}">
                            <i class="fe fe-settings  fe-16"></i>
                            <span class="ml-1 item-text">مدیریت فروشگاه</span>
                        </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item dropdown">
                <a href="#charts" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle nav-link">
                    <i class="fe fe-edit fe-16"></i>
                    <span class="ml-3 item-text">مدیریت کالا ها</span>
                </a>
                <ul class="collapse list-unstyled pl-4 w-100" id="charts">
                    <li class="nav-item">
                        <a class="nav-link pl-3" href="{{ route('product.form') }}">
                            <i class="fe fe-plus  fe-16"></i>
                            <span class="ml-1 item-text">افزودن کالا</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link pl-3" href="{{ route('product.manage') }}">
                            <i class="fe fe-settings  fe-16"></i>
                            <span class="ml-1 item-text">مدیریت کالا ها </span>
                        </a>
                    </li>
