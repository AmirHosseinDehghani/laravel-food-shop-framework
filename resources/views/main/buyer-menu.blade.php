...
<aside class="sidebar-left border-right bg-white shadow" id="leftSidebar" data-simplebar>
    ...
    <nav class="vertnav navbar navbar-light">
        ...
        <ul class="navbar-nav flex-fill w-100 mb-2">
            ...
            <li class="nav-item">
                <a class="nav-link pl-3" href="{{ route('home') }}"><i class="fe  fe-shopping-cart fe-16"></i>
                    <span class="ml-3 item-text">فروشگاه</span>
                </a>
            </li>
        ...
        <ul class="navbar-nav flex-fill w-100 mb-2">
            <li class="nav-item">
                <a class="nav-link pl-3" href="{{ route('manage.basket') }}"><i class="fe  fe-shopping-cart fe-16"></i>
                    <span class="ml-3 item-text"> سبد خرید و ثبت سفارش</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link pl-3" href="{{ route('manage.order') }}"><i class="fe  fe-shopping-cart fe-16"></i>
                    <span class="ml-3 item-text">مدیریت سفارشات و پرداخت</span>
                </a>
            </li>
        </ul>
        <p class="text-muted nav-heading mt-4 mb-1">
